package com.mineradio.app.navkit.scene
 ...
 * - [id]：由 [com.mineradio.app.navkit.path.NavigationPath] 分配的唯一自增整数
...
abstract class Scene {
     ...
     * 子类必须实现此方法以提供 UI 内容。
     *
     * 调用时 [LocalScene][com.mineradio.app.navkit.path.LocalScene] 已注入当前场景实例，
     * [LocalNavigationPath][com.mineradio.app.navkit.path.LocalNavigationPath] 已注入导航路径。
     */
    @Composable
     ...
     * [com.mineradio.app.navkit.stack.NavigationStack] 在场景可见期间自动调用 [FloatingContent]
     ...
     * StackScene 重写此方法等待 [com.mineradio.app.navkit.scene.StackScene.placed] 变为 true。
     */
