package com.mineradio.app.navkit.viewmodel
 ...
 * 然后调用 [viewModelStoreOwnerFor] 以 [LocalScene][com.mineradio.app.navkit.path.LocalScene]
...
class EntryViewModel : ViewModel() {
     ...
     * 如果尚不存在则自动创建并注册。
     *
     * @param sceneId 场景的唯一整数 ID，来自 [Scene.id][com.mineradio.app.navkit.scene.Scene.id]
     */
