package com.mineradio.app.crash
...
import com.mineradio.app.MainActivity
...
class CrashActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            // ★ 竖屏 Compose UI（含原 ui.theme.ProvideAppInteractionIndication）已移除，
            //   崩溃页自带一套最简 Material 主题即可
            MaterialTheme {
