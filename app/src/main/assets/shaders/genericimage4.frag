...
//uniform vec3 g_AmbientLowPass; // {"material":"ambientlowpass", "label":"ui_editor_properties_ambient", "type": "color", "default":"0 0.0 0.0","group":"ui_editor_properties_material"}
#endif
...
void main() {
	...
	vec3 normalizedViewVector = vec3(0.0, 0.0, 1.0);
#else
	...
	//color.rgb = mix(color.rgb, vec3(screenUV, 0.0), 0.99);
#endif
