...
void main() {
#if SPRITESHEET
#if SPRITESHEETBLEND
	// This is wrong because it can _sample colors that are invisible on one frame but changing this can negatively impact additive particles
	...
	//normal = vec4((v_TexCoord.xy - 0.5) * 2.0, 0.0, 1.0);
#if REFRACT
