...
#endif
#if FOLIAGEDEBUG == 1
	v_LightAmbientColor.rgb = vec3(radiusBlend, heightBlend, 0.0);
#elif FOLIAGEDEBUG == 2
	v_LightAmbientColor.rgb = vec3(0.0,heightBlend,0);
#elif FOLIAGEDEBUG == 3
	v_LightAmbientColor.rgb = vec3(radiusBlend, 0.0, 0.0);
#elif FOLIAGEDEBUG == 4
