...
#define in_SplineCP1 (a_TexCoordVec3C2.xyz)
	...
	float trailFadeOut = sin(saturate((in_TrailVertexIndex - segmentTimeOffsetInverse + 1.0) / usableLengthUnscaled) * 3.141);
#if TRAILFADEALPHA
...
#endif
#elif TRAILRENDERER
	float usableLength = in_ParticleTrailLength - 1.0;
	...
	// The first element is shorter based on the history timer and always starts and UV 0.0
