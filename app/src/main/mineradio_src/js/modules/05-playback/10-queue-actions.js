...
function moveQueueIndex(fromIdx, toIdx, opts) {
  console.log('[AutoplayDiag] SENTINEL moveQueueIndex called from=' + fromIdx + ' to=' + toIdx);
  opts = opts || {};
  ...
  if (currentSong) {
    ...
    currentIdx = -1;
    console.log('[AutoplayDiag] SENTINEL moveQueueIndex set currentIdx=-1 (currentSong missing)');
  }
