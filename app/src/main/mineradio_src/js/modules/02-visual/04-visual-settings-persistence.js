...
function readSavedLyricLayout() {
  ...
  try {
    ...
    return {
      ...
      desktopLyricsSize: clampRange(Number(raw.desktopLyricsSize) || fxDefaults.desktopLyricsSize, 0.10, 1.55),
...
function saveLyricLayout(opts) {
  ...
  try {
    ...
    var autosavePayload = {
      ...
      desktopLyricsSize: clampRange(Number(fx.desktopLyricsSize) || fxDefaults.desktopLyricsSize, 0.10, 1.55),
