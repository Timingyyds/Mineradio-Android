...
var RENDER_PIXEL_BUDGET = 3600000;
var RENDER_MIN_DPR = 0.6;
// 0 = display vsync. Foreground visible motion must keep VSync cadence.
var RENDER_VISIBLE_VSYNC = true;
var RENDER_IDLE_FPS = 54;
var RENDER_IDLE_LARGE_FPS = 48;
var RENDER_IDLE_HUGE_FPS = 36;
var RENDER_ACTIVE_FPS = 60;
var RENDER_LARGE_FPS = 54;
var RENDER_HUGE_FPS = 45;
var RENDER_INTERACTION_FPS = 0;
var RENDER_INTERACTION_LARGE_FPS = 60;
var RENDER_INTERACTION_HUGE_FPS = 54;
...
function renderQualityProfile() {
  ...
  if (quality === 'eco') return { cap: lowSpec ? 0.62 : 0.72, min: 0.42, budget: lowSpec ? 1500000 : 1900000 };
  if (quality === 'balanced') return { cap: lowSpec ? 0.72 : 0.9, min: 0.5, budget: lowSpec ? 2200000 : 2800000 };
  if (quality === 'ultra') return { cap: 1.4, min: 0.7, budget: 6000000 };
