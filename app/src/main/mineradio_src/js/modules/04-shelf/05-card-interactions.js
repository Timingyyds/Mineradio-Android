// ============================================================
var _sharedRaycaster = null;
var _sharedRayVec2 = null;
function raycasterFromPointerEvent(e) {
  ...
  if (!_sharedRaycaster) {
    ...
    _sharedRayVec2 = new THREE.Vector2();
  }
  _sharedRayVec2.set(mx, my);
  _sharedRaycaster.setFromCamera(_sharedRayVec2, camera);
  return _sharedRaycaster;
}
