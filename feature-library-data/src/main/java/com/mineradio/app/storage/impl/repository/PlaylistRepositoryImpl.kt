...
import com.mineradio.app.storage.impl.di.DatabaseBackupManager
...
class PlaylistRepositoryImpl(
    ...
    private fun backupToExternal() {
        DatabaseBackupManager.backup(app)
    }
    ...
    override suspend fun createPlaylist(name: String): Long = withContext(Dispatchers.IO) {
        val id = playlistDao.insertPlaylistAndGetId(PlaylistEntity(playlistName = name))
        backupToExternal()
        id
    }
